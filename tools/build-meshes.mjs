...
for (const f of files) {
  ...
  out[d.source] = { name: d.name, q: d.quant, v: d.verts, e: d.edges };
  verts += d.verts.length / 3;
  edges += d.edges.length / 2;
}

const body = `/* 3D 뼈대 — tools/build-meshes.mjs 가 만든다. 손으로 고치지 말 것.
 *
 * 꼭짓점과 모서리 좌표만 들어 있다. 출처와 라이선스는
...
console.log(`studio-meshes.js — 모델 ${files.length}개 · 꼭짓점 ${verts} · 모서리 ${edges}`);
