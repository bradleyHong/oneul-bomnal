...
(function () {
  ...
  var SOURCES = {
    weather: {
      ...
      desc:
        "기온 · 습도 · 풍속과 일출입 시각을 읽어 배경의 색온도와 움직임의 속도를 정합니다. " +
        "아침에 보는 로비 화면과 한밤중에 보는 화면이 같지 않습니다.",
      uses: [
        "일출입 시각에 맞춘 낮 · 밤 화면 전환",
        "계절과 그날 날씨에 따른 색 · 속도 변화",
        "실시간 연동이 필요 없으면 같은 화면을 4K 영상으로 대체",
      ],
    ...
    air: {
      ...
      desc:
        "초미세먼지 농도에 따라 입자의 수와 시야 거리가 달라집니다. 공기가 나쁜 날에는 화면도 탁해집니다. " +
        "지자체 로비에서 그날의 공기를 그대로 보여 주는 방식으로 씁니다.",
      uses: [
        "초미세먼지 등급에 따른 입자 수 · 시야 변화",
        "야외활동 가능 여부를 색으로 보여 주는 화면",
        "측정소 갱신 주기에 맞춘 자동 반영",
      ],
    ...
    db: {
      ...
      desc:
        "기관이 이미 가진 데이터를 화면의 재료로 씁니다. 행사 일정, 이용자 수, 지역 소식 같은 값이 " +
        "타이포와 흐름으로 나타납니다. 담당자가 영상을 갈아 끼우지 않아도 화면이 매일 달라집니다.",
      uses: [
        "행사 일정 · 이용 현황 등 기관 보유 데이터 연동",
        "다국어 타이포 미디어아트로 표현",
        "기관 CI · 컬러 · 서체 사전 반영",
      ],
